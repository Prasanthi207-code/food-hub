...
const seedJobs: EmployeeJob[] = [
  ...
  { id: "DON-1049", food: "Fresh produce boxes", category: "Fresh produce", quantity: 18, servings: 72, donor: "Green Leaf Restaurant", donorType: "Business", pickup: "789 Elm Boulevard, Eastside", destination: "Northside Shelter", window: "7:00 PM - 8:00 PM", distance: 5.8, priority: "medium", status: "accepted", employee: "Alex Morgan", createdAt: "2026-09-06T11:15:00.000Z", notes: "Ask for the kitchen manager at the rear entrance." },
